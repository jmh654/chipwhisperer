...
//!!!!!!!
    init_rand(0);
    mbedtls_rsa_init( &rsa_ctx, MBEDTLS_RSA_PKCS_V15, 0 ); // MBEDTLS_RSA_PKCS_V15 ersetzten? 
    ...
    mebdtls_mpi_read_binary( &rsa_ctx.N , 16, RSA_N );
    /*
...
#endif
{
    ...
    //buf bzw hash verwenden -> putput = buf, input = hash? 
