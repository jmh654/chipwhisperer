...
//debugging
uint8_t debug_buffer[256]; //32=8*4, 64=8*8, 128 = 16*8 256 =32*8
...
void rsa_init(void)
{
    ...
    */
    ...
    //from binary: mbedtls_mpi *X, const unsigned char *buf, size_t buflen
    mbedtls_mpi_read_binary( &rsa_ctx.N, modulus32, sizeof(modulus32));
    mbedtls_mpi_read_binary( &rsa_ctx.E, pub_exponent32, sizeof(pub_exponent32));
    mbedtls_mpi_read_binary( &rsa_ctx.D, priv_exponent32, sizeof(priv_exponent32));
    mbedtls_mpi_read_binary( &rsa_ctx.P, p32, sizeof(p32));
    mbedtls_mpi_read_binary( &rsa_ctx.Q, q32, sizeof(q32));
    mbedtls_mpi_read_binary( &rsa_ctx.DP, dp32, sizeof(dp32));
    mbedtls_mpi_read_binary( &rsa_ctx.DQ, dq32, sizeof(dq32));
    mbedtls_mpi_read_binary( &rsa_ctx.QP, qinv32, sizeof(qinv32));
...
uint8_t buf[128];
uint8_t hash[64]; // zu key size angeben 
